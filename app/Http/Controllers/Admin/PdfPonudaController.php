...
class PdfPonudaController extends Controller
{
    ...
    { 
       ...
       return view('admin.pdfponude.ponuda')->withEvidencija($evidencija)->with('stavke',$stavke);
    }
    ...
    public function stavke($id)
    {
        ...
        $evidencija = \App\Evidencijaposlova::findOrFail($id);
        $stavke = \App\StavkePosla::where('evidencijaposlova_id', '=', $evidencija->id)->get();
        return view('admin.pdfponude.stavka')
    ...
    public function stavkematerijali($ev_id, $id)
    {
        ...
        return view('admin.pdfponude.stavkamaterijal')
