...
<div class="container">
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
             <p><a href="{{ url('admin/projekt/stavke',[$evidencija->id]) }}" class="btn btn-warning pull-right"><i class="fa fa-arrow-circle-left"></i> Natrag</a></p>
              ...
              <div class="row top-adddress">
    			...
    			<div class="col-xs-6 head-adddress-right">
                 ...
                 <div class="row invoice">
                    <div class="col-xs-12">
                        <h3>STAVKA RAČUNA BR: 0{{ $evidencija->id }}.{{ $evidencija->created_at->format('my') }}-1</h3>
    			</div>
    		</div><!--invoice-->
