              ...
              <div class="row top-adddress">
    			...
    			<div class="col-xs-6 head-adddress-right">
                            <address class="pull-right">
                                <p><strong>{{ $evidencija->mjesto_rada }}</strong></p>
                                <p><strong>{{ $evidencija->narucitelj_adresa }}</strong></p>
                                <p><strong>{{ $evidencija->narucitelj_oib }}</strong></p>
                            </address>
                 ...
                 <div class="row invoice">
                    <div class="col-xs-12">
                        <h3>STAVKE RAČUNA BR: 0{{ $evidencija->id }}.{{ $evidencija->created_at->format('my') }}-1</h3>
    			</div>
    		</div><!--invoice-->
                                    ...
                                    <table class="table table-condensed">
                                        <thead>
                                            <tr>
                                                ...
                                                <td class="text-center"><strong>Cijena posla</strong></td>
                                                <td class="text-center"><strong>Ukupna cijena</strong></td>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right">{{ $s->cijena_posla }} </td>
