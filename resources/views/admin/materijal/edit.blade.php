            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    <div class="panel-heading">
                         <p><a href="{{ url('/admin/materijal') }}" class="btn btn-warning pull-right"><i class="fa fa-arrow-circle-left"></i> Natrag</a></p>
                    ...
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" role="form" method="POST" action="/admin/materijal/{{ $id }}">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p class="lead">
                        <i class="fa fa-question-circle fa-lg"></i> Jeste li sigurni da želite obrisati ovaj materijal ?
                    </p>
                </div>
                <div class="modal-footer">
                    <form method="POST" action="/admin/materijal/{{ $id }}">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
